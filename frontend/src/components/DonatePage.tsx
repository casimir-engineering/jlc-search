    ...
    <div className="donate-page">
      ...
      <div className="donate-grid">
        <div className="donate-card" style={{minWidth: '100%'}}>
          <h2>Patreon</h2>
          <p className="donate-hint">Support JLCsearch on Patreon and get AI-powered component search.<br/>Your Claude, Codex or any AI can find any part from 3.5M+ components.</p>
