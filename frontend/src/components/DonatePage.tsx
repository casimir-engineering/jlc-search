    ...
    <div className="donate-page">
      ...
      <div className="donate-grid">
        <div className="donate-card" style={{minWidth: '100%'}}>
          <h2>Patreon</h2>
          <p className="donate-hint">Support Raph Search on Patreon and get AI-powered component search.<br/>Your Claude, Codex or any AI can find any part from 3.5M+ components.</p>
          <div style={{marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center'}}>
            ...
            <a href="https://search.raph.io/mcp-api/key" className="patreon-btn" style={{background: '#2a2a3e', border: '1px solid #555'}}>
